...
* `Object`
    ...
    * `signInputs` : `Array`
        * `Object`
            ...
            * `sighashTypes` : `Integer[]` - _(Optional)_ Specifies which part of the transaction to sign. Default is `[1]`.
...
* `Object`
    ...
    * `address` : `String` - _(Optional)_ The Dogecoin address to use to sign the message.
